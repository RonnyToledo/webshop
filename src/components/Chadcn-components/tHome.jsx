          ...
          <section className="bg-white rounded-lg shadow-md p-2 mb-4">
            <div className="container px-4 md:px-6">
              <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                ...
                comprometido a brindarte una experiencia de compra excepcional,
                donde la calidad y el servicio al cliente son nuestra prioridad.
                Te invitamos a explorar nuestras ofertas y descubrir por qué
                somos la opción preferida en la comunidad. ¡Gracias por
                elegirnos!
              </p>
            </div>
            <div className="pt-10 flex flex-col items-center justify-center">

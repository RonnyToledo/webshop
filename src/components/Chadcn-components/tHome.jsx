    ...
    <>
      {store.loading == 100 ? (
        <main className="p-4 bg-gray-100">
            ...
            <section className="bg-white rounded-lg shadow-md p-2 mb-4">
              <div className="container px-4 md:px-6">
                <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  ...
                  satisfacer todas tus necesidades. Nuestro equipo está
                  comprometido a brindarte una experiencia de compra
                  excepcional, donde la calidad y el servicio al cliente son
                  nuestra prioridad. Te invitamos a explorar nuestras ofertas y
                  descubrir por qué somos la opción preferida en la comunidad.
          ...
          {store.products.filter((ele) => ele.favorito && !ele.agotado)
            .length >= 0 && (

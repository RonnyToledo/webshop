      ...
      <main className="flex-grow p-4 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            The Nike Air Max 270 delivers a plush ride and modern look. The Max Air 270 unit provides all-day comfort
            while the sleek upper design adds a stylish touch.
          </p>
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              ...
              <span className="flex items-center justify-center w-8 h-8 border rounded-md">1</span>
              <Button size="sm" variant="outline">
                +
              </Button>
            </div>
